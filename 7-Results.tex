...
The resulting trajectory presents some interesting artefacts in the 3D plot. Once thrusting at periapsis ceases, the apoapsis stops increasing significantly. Thus the orbits are much closer together in the plot, appearing as though an inclination change has occurred.
...
Finally, \autoref{fig:Ascent2-energy} shows the power levels throughout this phase. 
...
% Use of time as independent parameter during propagate and capture phases
...
The objective of this phase, raising the spacecraft periapsis, is shown in \autoref{fig:Ascent-peri}. The orbit raising is observed to be cyclical, demonstrating the Oberth effect. As a result of this effect the optimised profile reduces thrust during apoapsis, conserving fuel when it is inefficient to thrust.
...
The nearly constant thrust results in fuel consumption being almost linear with time. This can be seen in \cite{fig:Ascent-mass}, which plots the wet mass of the spacecraft over the phase. From the plot, this simulation suggested approximately 60~kg worth of ammonia would be required for the ascent phase. %compare to initial guess?

fully optimised trajectory takes a couple of days longer, saves 6kg
32 days in van Allen belts? acceptable radiation damage
