...
\caption{Descent trajectory in LCI frame viewed from north pole. The orbits behind the Moon partly show through due to an error in the vector graphics print driver.} \label{fig:Descent-3D-lci}
\end{figure}
...
\caption{Science trajectory in LCI frame viewed from north pole. The orbits behind the Moon partly show through due to an error in the vector graphics print driver.} \label{fig:Science-3D-lci}
\end{figure}
