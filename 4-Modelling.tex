...
To use the NASA SPICE libraries the optimisations performed in GESOP were restricted to the J2000.0 frame, so for consistency it was also used in the STK simulations.
