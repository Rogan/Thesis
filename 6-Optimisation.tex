\chapter{Optimisation methods} \label{cha:Optimisation-methods}
...
Indirect methods rely on complex mathematics, as outlined by \textcite{Pontryagin1962}.
...
% Betts \cite{SOCS_guide} calls this SQP
