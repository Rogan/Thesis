...
\end{gather}
\end{subequations}
where $h$ is the step size \parencite[p. 797]{Kreyszig1979}%\parencite[p. 710]{recipes}
. A similar, commonly used method in optimal control is Hermite-Simpson interpolation \parencite[p. 197]{Kreyszig1979}%\parencite[p. 134]{recipes}
.
